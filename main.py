...
# internal game resolution: display is the "inside" - everything is rendered onto the display, and the display is resized to the size of the pygame window, also resizing everything rendered on the display by the same ratios.
...
bird_image = pygame.image.load("sprites/bird.png").convert()
bird_image.set_colorkey((0,0,0))
obstacle_image = pygame.image.load('sprites/obstacle.png').convert()
...
class Player:
    def __init__(self, game, x, y, width, height):
        ...
        # upwards and downwards work against each other: upwards is a constant; downwards increments with each frame, giving an "accelerating" effect of gravity that resets on jump.
        self.downwards = 0
        self.upwards = -3
        self.jumped = False
